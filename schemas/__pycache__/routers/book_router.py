...
router = APIRouter(prefix="/api/v1/books", tags=["Book"])
...
def borrow_warning(threeshold: int = 5, db: Session = Depends(get_db)):
    return book_service.borrow_warning(db, threeshold)
